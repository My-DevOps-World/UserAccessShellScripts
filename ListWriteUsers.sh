#!/bin/bash
####################
#Script to find the users with write role for desired Github Repo
#Author: Ram
#Version: v1.0
###################
...
function list_users_with_read_access {
    ...
    collaborators="$(github_api_get "$endpoint" | jq -r '.[] | select(.role_name == "admin") | .login')"
